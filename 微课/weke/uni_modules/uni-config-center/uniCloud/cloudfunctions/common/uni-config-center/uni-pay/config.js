...
module.exports = {
	...
	"notifyUrl": {
		...
		"tcb-pwxt7mejf8zs8rb-1cwte216d53a": "https://tcb-pwxt7mejf8zs8rb-1cwte216d53a.service.tcloudbase.com/uni-pay-co",
	},
	...
	"wxpay": {
		...
		// 微信 - 小程序支付
		"mp": {
			"appId": "wxb77ba7aa134b341f", // 小程序的appid
			"secret": "0fe022b41897142359794f8778e4d963", // 小程序的secret
			"mchId": "1668869320", // 商户id
			"key": "DC574EFBB1C0BE80857BA1CE2A3F4DA2", // v2的api key
			"pfx": fs.readFileSync(__dirname + '/wxpay/apiclient_cert.p12'), // v2需要用到的证书
			"v3Key": "C1CB4583BE7A60F69E2767F1571B4D91", // v3的api key
